<template>
    <main class="fixed flex top-0 left-0 justify-between w-full items-start h-20 z-50">
        <section :class="{ 'bg-blue-500 py-5': $store.state.scroll}" class="px-12 py-4 flex-grow  custom-transition flex justify-between items-center text-gray-200 z-50">
            ...
            <main class="flex items-center">
                <router-link v-if="$store.state.user" to="/admin" class="w-full px-4 mr-3 bg-opacity-90 block text-gray-200">
